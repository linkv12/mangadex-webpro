...
--
-- Host: localhost
-- Generation Time: Apr 13, 2019 at 04:45 PM
...
ALTER TABLE `scan_group`
  ...
  ADD KEY `idGroupStat` (`idGroupStat`);
...
--
ALTER TABLE `scan_group`
  MODIFY `idScanGroup` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `group_stat`
  ADD CONSTRAINT `group_stat_ibfk_1` FOREIGN KEY (`idGroupStat`) REFERENCES `scan_group` (`idScanGroup`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `scan_group`
  ADD CONSTRAINT `scan_group_ibfk_1` FOREIGN KEY (`idGroupStat`) REFERENCES `group_stat` (`idGroupStat`) ON DELETE NO ACTION ON UPDATE NO ACTION;
