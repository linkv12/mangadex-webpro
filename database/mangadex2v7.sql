...
--
-- Host: localhost
-- Generation Time: Apr 19, 2019 at 11:25 AM
...
(1, 'Monster Musume', 'Aldrin', 'Tgn kiri aldrin', 'Coli 3 kasli sehari sehat', 'English', 'default_manga_cover.png', 'Langsung complete', '03-04-2019, 22:50:23', NULL),
...
(2, 'onanimous', 'anonimus', 'admin', 'default_group_banner.png', NULL);
...
--
ALTER TABLE `chapter`
  MODIFY `idChapter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `picture`
  MODIFY `idPicture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1504;
