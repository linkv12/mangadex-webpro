...
--
-- Host: localhost
-- Generation Time: Apr 23, 2019 at 06:34 PM
...
INSERT INTO `chapter` (`idChapter`, `idManga`, `chapter_number`, `chapter_title`, `langguage`, `idScanGroup`, `uploader`, `view`, `upload_time`, `idThread`) VALUES
(8, 1, 1, 'TEST', 'English', 2, 'pandemonium', 0, '23-04-2019, 17:48:19', NULL),
(9, 2, 1, 'TEST', 'English', 2, 'pandemonium', 0, '23-04-2019, 17:51:22', NULL);
...
--
-- Dumping data for table `chapter_stat`
--

INSERT INTO `chapter_stat` (`idChapter`, `view`) VALUES
(8, 0),
(9, 0);
...
INSERT INTO `picture` (`idPicture`, `idChapter`, `relative_path`, `file_name`, `picture_number`) VALUES
(309, 8, 'assets/pictures/1/1_1_pandemonium_17481923042019', '1.png', 1),
(310, 8, 'assets/pictures/1/1_1_pandemonium_17481923042019', '2.png', 2),
(311, 8, 'assets/pictures/1/1_1_pandemonium_17481923042019', '4.png', 4),
(312, 8, 'assets/pictures/1/1_1_pandemonium_17481923042019', '3.png', 3),
(313, 9, 'assets/pictures/2/1_2_pandemonium_17512223042019', '1.png', 1),
(314, 9, 'assets/pictures/2/1_2_pandemonium_17512223042019', '2.png', 2),
(315, 9, 'assets/pictures/2/1_2_pandemonium_17512223042019', '4.png', 4),
(316, 9, 'assets/pictures/2/1_2_pandemonium_17512223042019', '3.png', 3);
...
('pandemonium', 1, '', '5f4dcc3b5aa765d61d8327deb882cf99', '', 'default_avatar.jpg', '', '23-04-2019, 13:43:01', 1, 2);
...
--
ALTER TABLE `chapter`
  MODIFY `idChapter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `picture`
  MODIFY `idPicture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=317;
