...
INSERT INTO `chapter` (`idChapter`, `idManga`, `chapter_number`, `chapter_title`, `langguage`, `idScanGroup`, `uploader`, `view`, `upload_time`) VALUES
(2, 1, 1, 'Aldrin strike again', 'English', 2, 'admin', 0, '69-69-2069, 69:69:69');
...
INSERT INTO `manga` (`idManga`, `Title`, `Author`, `Artist`, `description`, `og_langguage`, `cover`, `pub_status`, `updated_on`) VALUES
(1, 'Monster Musume', 'Aldrin', 'Tgn kiri aldrin', 'Coli 3 kasli sehari sehat', 'English', 'default_manga_cover.png', 'Langsung complete', '03-04-2019, 22:50:23'),
(2, 'Mangaka is dead', 'kuku', 'klan', 'hiiiiiiiiiiiiiiiiii', 'English', 'default_manga_cover.png', 'Complete', '03-04-2019, 22:50:24'),
(3, 'aaaaaaa', 'aaaaaaaaaaaaa', 'aaaaaaaaaaaa', 'bbbbbbbbbb', 'English', 'default_manga_cover.png', 'On Going', '03-04-2019, 22:50:25'),
(4, 'akankah skip', 'oo', 'p', 'q', 'English', 'default_manga_cover.png', 'On Going', '15-04-2019, 04:23:08');
