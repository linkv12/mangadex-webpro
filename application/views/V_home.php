                    ...
                    <?php if ($tal == 1): ?>
                      ...
                      <div class='col-md-6 border-bottom p-2'>
                        <div class='hover sm_md_logo rounded float-left mr-2'>
                          <?php $cover_one = $this->M_Model->getMangaCover($temp_data[0]['idManga']); ?>
                        ...
                        <div class='pt-0 pb-1 mb-1 border-bottom d-flex align-items-center flex-nowrap'>
                          ...
                          <a class='manga_title text-truncate' title='Parallel Paradise' href='/title/21040/parallel-paradise'><?= $this->M_Manga->getMangaTitle($temp_data[0]['idManga']);?></a>
                        </div>
                        <div class='py-0 mb-1 row no-gutters align-items-center flex-nowrap'>
                          ...
                          <div class='text-truncate py-0 mb-1'>
                            <span class='fas fa-users fa-fw ' aria-hidden='true'></span> <?echo "NOT YET IMPLEMENTED";?>
                            <a href='/group/777/making-babies'></a>
                          </div>
                          <div class='text-truncate py-0 mb-1'><span class='far fa-clock fa-fw ' aria-hidden='true'></span> <? echo timespan( strtotime($temp_data[0]['upload_time']),$now, 1)?>   <span class='d-none d-xl-inline'>ago</span></div>
                      </div>
                      <!---->
                      <!---->
                      <div class='col-md-6 border-bottom p-2'>
                      <div class='hover sm_md_logo rounded float-left mr-2'>
                        <?php $cover_two = $this->M_Model->getMangaCover($temp_data[1]['idManga']); ?>
                        <a href='/title/29854/switch'>
                          <img class='rounded max-width' src='<?=base_url('assets/manga_cover/'.$cover_two);?>'>
                        </a></div>
                      <div class='pt-0 pb-1 mb-1 border-bottom d-flex align-items-center flex-nowrap'>
                      <div><span class='fas fa-book fa-fw mr-1' aria-hidden='true'></span></div>
                      <a class='manga_title text-truncate' title='Switch' href='/title/29854/switch'><?= $this->M_Manga->getMangaTitle($temp_data[1]['idManga']);?></a>
                      </div>
                      <div class='py-0 mb-1 row no-gutters align-items-center flex-nowrap'>
                        <span class='far fa-file fa-fw col-auto mr-1' aria-hidden='true'></span>
                      ...
                      <div class='text-truncate py-0 mb-1'><span class='fas fa-users fa-fw ' aria-hidden='true'></span><?= "NOT YET IMPLEMENTED"?><a href='/group/5625/mono-scans'></a></div>
                      <div class='text-truncate py-0 mb-1'><span class='far fa-clock fa-fw ' aria-hidden='true'></span> <? echo timespan(strtotime($temp_data[1]['upload_time']),$now, 1)?>   <span class='d-none d-xl-inline'>ago</span></div>
                      </div>
                      <!---->
                      <?php else: ?>
                        <?php $temp_data[$tal] = $value;
