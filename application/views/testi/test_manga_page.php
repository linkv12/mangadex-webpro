  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <?php
            ...
            echo "elapsed aft->before : ". timespan($bef, $aft, 2);
      ?>
      ...
      <a href="<?= site_url('Landing/load_test_add_chapter/'.$idManga.'/'.$title)?>">add_test_chapter</a>
      <div class="container">
      </br></br></br>
      <?php $all_chapter = $this->Chapter->getChapterByMangaId($idManga) ?>
      <?php if ($all_chapter == NULL) {
        echo "Chapter is empty";
      } else {
        foreach ($all_chapter->result_array() as $row){
          #echo 'idChapter : '.$row['idChapter'].' </br> ';
          #echo 'idManga : '.$row['idManga'].' </br> ';
          echo 'chapter_number : '.$row['chapter_number'].' </br> ';
          echo 'chapter_title  : '.$row['chapter_title'].' </br> ';
          echo 'langguage      : '.$row['langguage'].' </br> ';
          echo 'idScanGroup    : '.$row['idScanGroup'].' </br> ';
