				...
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown mx-1">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item " href="<?= site_url('C_Manga/allManga')?>"><span class="fas fa-book fa-fw" aria-hidden="true"></span> Titles</a>
							...
							<a class="dropdown-item " href="<?= site_url('C_Manga/addManga')?>"><span class="fas fa-plus-circle fa-fw " aria-hidden="true"></span> Add</a>
						</div>
					</li>
					...
					<li class="nav-item mx-1 dropdown">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="#" rel="nofollow"><span class="fas fa-hashtag fa-fw " aria-hidden="true" title="IRC"></span> IRC</a>
						</div>
					</li>
					<li class="nav-item mx-1 dropdown">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="#"><span class="fas fa-clipboard fa-fw " aria-hidden="true" title="Stats"></span> Stats</a>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item mx-1 dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="<?= site_url('C_login') ?>"><span class="fas fa-sign-in-alt fa-fw " aria-hidden="true" title="Log in"></span> Log in</a>
								<a class="dropdown-item" href="<?= site_url('C_register') ?>"><span class="fas fa-pencil-alt fa-fw " aria-hidden="true" title="Sign up"></span> Sign up</a>
							</div>
						</li>
					</ul>
				<?php } else { ?>
					...
					<li class="nav-item mx-1 dropdown">
						<a href="<?= site_url('C_ctrlUser')?>" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							<span class="fas fa-user fa-fw " aria-hidden="true"></span> <span class="d-lg-none d-xl-inline" style="color: #06f"> <?= $_SESSION['username']?> </span>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="<?= site_url('C_usrProfile') ?>">
								...
								<a class="dropdown-item" href="<?= site_url('C_userSetting') ?>"><span class="fas fa-cog fa-fw " aria-hidden="true" title="Settings"></span> Settings</a>
								...
								<a class="dropdown-item" href="#"><span class="fas fa-envelope fa-fw " aria-hidden="true" title="Inbox"></span> Inbox </a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="#"><span class="fas fa-dollar-sign fa-fw " aria-hidden="true" title="support"></span> Support</a>
								<div class="dropdown-divider"></div>
								<!--- change to use site_url-->
								<a class="dropdown-item logout" href="<?=site_url('C_login/logout')?>"><span class="fas fa-sign-out-alt fa-fw " aria-hidden="true" title="Log out"></span> Log out</a>
							</div>
						</li>
					</ul>
				<?php } ?>
